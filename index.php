...
<body>
    ...
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="contact.php" class="nav-link scrollto"><i class="bx bx-envelope"></i> <span>Contact Me</span></a></li>
        </ul>
      </nav><!-- .nav-menu -->
    </div>
  </header><!-- End Header -->
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1>MD SHAMIM</h1>
      <p>I'm <span class="typed" data-typed-items="Full Stuck Web Developer, Web Designer, Frontend Developer, Backend Developer, Freelancer, Photographer, Video Editor, Social Media Manager, Admin Officer"></span></p>
    </div>
  </section><!-- End Hero -->
